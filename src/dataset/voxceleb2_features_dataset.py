...
class Voxceleb2FeaturesDataset(Dataset):

    def __init__(self, voxceleb2_path, subdirectory, normalizer=None, features_path='features'):
        self._voxceleb2_path = voxceleb2_path
        self._subdirectory = subdirectory
        features_path = self._voxceleb2_path + os.sep + features_path
